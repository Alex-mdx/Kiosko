        ...
        child: Column(children: [
                    ...
                    child: Padding(
                        ...
                        child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                                hintText:
                                    'Ingresar el numero de folio de venta',
          ...
          Expanded(
              ...
              child: Container(
                  ...
                  color: LightThemeColors.background,
                  child:
                      const Text('Esta ventana traera las ultimas 20 ventas')))
        ]));
  }
              ...
              IconButton(
                  ...
                  onPressed: () async {
                    if (provider.selectDevice == null) {
                      ...
                      if (result) {
                        await PrintFinal.ventaBoletaje(provider: provider,
                            type: provider.selectDevice!, venta: venta);
                      } else {
                  ...
                  icon:
                      const Icon(Icons.print, color: LightThemeColors.primary)),
              IconButton(
                  iconSize: 16.sp,
                  onPressed: () {
                    showDialog(
                            context: context,
                            builder: (context) =>
                                Dialog(child: DialogAdminDetalle(venta: venta)))
                        .then((value) async {
                      if (!folio) {
                        await getFolio();
                      } else {
